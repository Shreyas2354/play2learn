...
export const missions: Mission[] = [
  ...
  },
  {
    ...
    questions: [
        ...
        },
        {
            ...
            type: 'mcq',
             options: [
                { id: 'a', text: '4', text_hi: '4', text_te: '4' },
                { id: 'b', text: '5', text_hi: '5', text_te: '5' },
                { id: 'c', text: '6', text_hi: '6', text_te: '6' },
                { id: 'd', text: '7', text_hi: '7', text_te: '7' },
            ],
            correctAnswer: 'b',
            difficulty: 'easy',
        ...
        },
        {
            ...
            type: 'mcq',
            options: [
                { id: 'a', text: '90', text_hi: '90', text_te: '90' },
                { id: 'b', text: '180', text_hi: '180', text_te: '180' },
                { id: 'c', text: '270', text_hi: '270', text_te: '270' },
                { id: 'd', text: '360', text_hi: '360', text_te: '360' },
            ],
            correctAnswer: 'd',
            difficulty: 'easy',
        ...
        },
        {
            ...
            type: 'mcq',
            options: [
                { id: 'a', text: '8 cm²', text_hi: '8 cm²', text_te: '8 cm²' },
                { id: 'b', text: '15 cm²', text_hi: '15 cm²', text_te: '15 cm²' },
                { id: 'c', text: '16 cm²', text_hi: '16 cm²', text_te: '16 cm²' },
                { id: 'd', text: '25 cm²', text_hi: '25 cm²', text_te: '25 cm²' },
            ],
            correctAnswer: 'b',
            difficulty: 'easy',
  ...
  },
  {
    ...
    badge_color: 'bg-red-400 text-red-900',
    questions: [
        { id: 1, text: 'What is 1/2 of 10?', text_hi: '10 का 1/2 क्या है?', text_te: '10లో 1/2 ఎంత?', type: 'mcq', correctAnswer: 'a', options: [{id: 'a', text: '5', text_hi: '5', text_te: '5'}, {id: 'b', text: '4', text_hi: '4', text_te: '4'}, {id: 'c', text: '6', text_hi: '6', text_te: '6'}, {id: 'd', text: '12', text_hi: '12', text_te: '12'}], difficulty: 'easy', hints: ['It means 10 divided by 2.', 'If you have 10 sweets and share them equally with a friend, how many do you each get?', 'It is half of ten.'], hints_hi: ['इसका मतलब है 10 को 2 से विभाजित करना।', 'यदि आपके पास 10 मिठाइयाँ हैं और आप उन्हें एक दोस्त के साथ बराबर साझा करते हैं, तो प्रत्येक को कितनी मिलती हैं?', 'यह दस का आधा है।'], hints_te: ['అంటే 10 ను 2 తో భాగించడం.', 'మీ దగ్గర 10 స్వీట్లు ఉంటే మరియు వాటిని స్నేహితుడితో సమానంగా పంచుకుంటే, ప్రతి ఒక్కరికి ఎన్ని వస్తాయి?', 'ఇది పదిలో సగం.'] },
        { id: 2, text: 'If a pizza has 8 slices and you eat 2, how many slices are left?', text_hi: 'यदि एक पिज्जा में 8 स्लाइस हैं और आप 2 खाते हैं, तो कितने स्लाइस बचते हैं?', text_te: 'ఒక పిజ్జాలో 8 ముక్కలు ఉంటే మరియు మీరు 2 తింటే, ఎన్ని ముక్కలు మిగులుతాయి?', type: 'mcq', correctAnswer: 'c', options: [{id: 'a', text: '4', text_hi: '4', text_te: '4'}, {id: 'b', text: '5', text_hi: '5', text_te: '5'}, {id: 'c', text: '6', text_hi: '6', text_te: '6'}, {id: 'd', text: '7', text_hi: '7', text_te: '7'}], difficulty: 'easy', hints: ['This is a subtraction problem.', '8 - 2 = ?', 'Count the remaining pieces.'], hints_hi: ['यह एक घटाव की समस्या है।', '8 - 2 = ?', 'शेष टुकड़ों को गिनें।'], hints_te: ['ఇది ఒక తీసివేత సమస్య.', '8 - 2 = ?', 'మిగిలిన ముక్కలను లెక్కించండి.'] },
        { id: 3, text: 'What is 1/2 + 1/2 equal to?', text_hi: '1/2 + 1/2 किसके बराबर है?', text_te: '1/2 + 1/2 దేనికి సమానం?', type: 'mcq', correctAnswer: 'b', options: [{id: 'a', text: '1/4', text_hi: '1/4', text_te: '1/4'}, {id: 'b', text: '1', text_hi: '1', text_te: '1'}, {id: 'c', text: '2/4', text_hi: '2/4', text_te: '2/4'}, {id: 'd', text: '2', text_hi: '2', text_te: '2'}], difficulty: 'easy', hints: ['Two halves make a whole.', 'If you have half a pizza and get another half, you have a whole pizza.', 'The answer is a whole number.'], hints_hi: ['दो आधे मिलकर एक पूरा बनाते हैं।', 'यदि आपके पास आधा पिज्जा है और आपको दूसरा आधा मिलता है, तो आपके पास एक पूरा पिज्जा है।', 'उत्तर एक पूर्ण संख्या है।'], hints_te: ['రెండు సగాలు ఒక పూర్తిని చేస్తాయి.', 'మీ దగ్గర సగం పిజ్జా ఉంటే మరియు మరొక సగం వస్తే, మీ దగ్గర పూర్తి పిజ్జా ఉంటుంది.', 'సమాధానం ఒక పూర్ణ సంఖ్య.'] },
        { id: 4, text: 'If a cake is cut into 4 equal pieces and you eat 1 piece, what fraction is left?', text_hi: 'यदि एक केक को 4 बराबर टुकड़ों में काटा जाता है और आप 1 टुकड़ा खाते हैं, तो कितना भिन्न बचता है?', text_te: 'ఒక కేకును 4 సమాన ముక్కలుగా కట్ చేసి మీరు 1 ముక్క తింటే, ఎంత భిన్నం మిగులుతుంది?', type: 'mcq', correctAnswer: 'd', options: [{id: 'a', text: '1/4', text_hi: '1/4', text_te: '1/4'}, {id: 'b', text: '2/4', text_hi: '2/4', text_te: '2/4'}, {id: 'c', text: '1/3', text_hi: '1/3', text_te: '1/3'}, {id: 'd', text: '3/4', text_hi: '3/4', text_te: '3/4'}], difficulty: 'easy', hints: ['How many pieces are remaining?', 'The total number of pieces is the bottom number.', 'You started with 4/4.'], hints_hi: ['कितने टुकड़े शेष हैं?', 'टुकड़ों की कुल संख्या नीचे की संख्या है।', 'आपने 4/4 से शुरू किया था।'], hints_te: ['ఎన్ని ముక్కలు మిగిలి ఉన్నాయి?', 'మొత్తం ముక్కల సంఖ్య కింది సంఖ్య.', 'మీరు 4/4 తో ప్రారంభించారు.'] },
        { id: 5, text: 'How many quarters are in a whole?', text_hi: 'एक पूरे में कितने चौथाई होते हैं?', text_te: 'ఒక పూర్తిలో ఎన్ని పావులు ఉంటాయి?', type: 'mcq', correctAnswer: 'c', options: [{id: 'a', text: '1', text_hi: '1', text_te: '1'}, {id: 'b', text: '2', text_hi: '2', text_te: '2'}, {id: 'c', text: '4', text_hi: '4', text_te: '4'}, {id: 'd', text: '8', text_hi: '8', text_te: '8'}], difficulty: 'easy', hints: ['A quarter is 1/4.', 'How many 1/4 pieces make a whole cake?', 'Think about 4 slices of pizza.'], hints_hi: ['एक चौथाई 1/4 है।', 'कितने 1/4 टुकड़े एक पूरा केक बनाते हैं?', 'पिज्जा के 4 स्लाइस के बारे में सोचें।'], hints_te: ['పావు 1/4.', 'ఎన్ని 1/4 ముక్కలు పూర్తి కేకును చేస్తాయి?', 'పిజ్జా యొక్క 4 ముక్కల గురించి ఆలోచించండి.'] }
    ]
  },
  {
  ...
  },
  {
    ...
    badge_color: 'bg-green-400 text-green-900',
    questions: [
      { id: 1, text: 'Which is the longest river in the world?', text_hi: 'दुनिया की सबसे लंबी नदी कौन सी है?', text_te: 'ప్రపంచంలో అత్యంత పొడవైన నది ఏది?', options: [{ id: 'a', text: 'Amazon', text_hi: 'अमेज़ॅन', text_te: 'అమెజాన్' }, { id: 'b', text: 'Nile', text_hi: 'नील', text_te: 'నైలు' }, { id: 'c', text: 'Ganges', text_hi: 'गंगा', text_te: 'గంగా' }], correctAnswer: 'b', difficulty: 'easy', hints: ["It is located in Africa.", "Ancient Egyptian civilization depended on it."], hints_hi: ["यह अफ्रीका में स्थित है।", "प्राचीन मिस्र की सभ्यता इसी पर निर्भर थी।"], hints_te: ["ఇది ఆఫ్రికాలో ఉంది.", "ప్రాచీన ఈజిప్షియన్ నాగరికత దీనిపై ఆధారపడి ఉంది."] },
      { id: 2, text: 'What is the largest desert in the world?', text_hi: 'दुनिया का सबसे बड़ा रेगिस्तान कौन सा है?', text_te: 'ప్రపంచంలో అతిపెద్ద ఎడారి ఏది?', options: [{ id: 'a', text: 'Sahara Desert', text_hi: 'सहारा रेगिस्तान', text_te: 'సహారా ఎడారి' }, { id: 'b', text: 'Gobi Desert', text_hi: 'गोबी रेगिस्तान', text_te: 'గోబీ ఎడారి' }, { id: 'c', text: 'Antarctic Polar Desert', text_hi: 'अंटार्कटिक ध्रुवीय रेगिस्तान', text_te: 'అంటార్కిటిక్ ధ్రువ ఎడారి' }], correctAnswer: 'c', difficulty: 'hard', hints: ["It is a cold desert.", "It covers most of a continent."], hints_hi: ["यह एक ठंडा रेगिस्तान है।", "यह एक महाद्वीप के अधिकांश हिस्से को कवर करता है।"], hints_te: ["ఇది ఒక చల్లని ఎడారి.", "ఇది ఒక ఖండంలోని చాలా భాగాన్ని కవర్ చేస్తుంది."] },
    ]
  },
  {
    id: 'gk-level-4',
