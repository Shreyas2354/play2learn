...
export const missions: Mission[] = [
    ...
    questions: [
        ...
        },
        {
            ...
            options: [
                ...
                { id: 'c', text: 'Thermodynamics', text_hi: 'ऊष्మप्रवैगिकी', text_te: 'ఉష్ణగతికశాస్త్రం' },
  ...
  },
  {
    ...
    badge_color: 'bg-red-400 text-red-900',
    questions: [
        { id: 1, text: 'What is 1/2 of 10?', text_hi: '10 का 1/2 क्या है?', text_te: '10లో 1/2 ఎంత?', options: [{ id: 'a', text: '2', text_hi: '2', text_te: '2' },{ id: 'b', text: '5', text_hi: '5', text_te: '5' },{ id: 'c', text: '10', text_hi: '10', text_te: '10' },{ id: 'd', text: '20', text_hi: '20', text_te: '20' }], correctAnswer: 'b', difficulty: 'easy', hints: ['It means 10 divided by 2.', 'If you have 10 sweets and share them equally with a friend, how many do you each get?', 'It is half of ten.'], hints_hi: ['इसका मतलब है 10 को 2 से विभाजित करना।', 'यदि आपके पास 10 मिठाइयाँ हैं और आप उन्हें एक दोस्त के साथ बराबर साझा करते हैं, तो प्रत्येक को कितनी मिलती हैं?', 'यह दस का आधा है।'], hints_te: ['అంటే 10 ను 2 తో భాగించడం.', 'మీ దగ్గర 10 స్వీట్లు ఉంటే మరియు వాటిని స్నేహితుడితో సమానంగా పంచుకుంటే, ప్రతి ఒక్కరికి ఎన్ని వస్తాయి?', 'ఇది పదిలో సగం.'] },
        { id: 2, text: 'Which fraction is bigger: 1/4 or 1/3?', text_hi: 'कौन सा भिन्न बड़ा है: 1/4 या 1/3?', text_te: 'ఏ భిన్నం పెద్దది: 1/4 లేదా 1/3?', options: [{ id: 'a', text: '1/4', text_hi: '1/4', text_te: '1/4' },{ id: 'b', text: '1/3', text_hi: '1/3', text_te: '1/3' },{ id: 'c', text: 'They are equal', text_hi: 'वे बराबर हैं', text_te: 'అవి సమానం' }], correctAnswer: 'b', difficulty: 'easy', hints: ['If you cut a cake into fewer pieces, the pieces are bigger.', 'The smaller the bottom number, the bigger the fraction.', 'Think about which slice of pizza would be bigger.'], hints_hi: ['यदि आप एक केक को कम टुकड़ों में काटते हैं, तो टुकड़े बड़े होते हैं।', 'नीचे की संख्या जितनी छोटी होगी, भिन्न उतना ही बड़ा होगा।', 'सोचें कि पिज्जा का कौन सा टुकड़ा बड़ा होगा।'], hints_te: ['మీరు కేకును తక్కువ ముక్కలుగా కట్ చేస్తే, ముక్కలు పెద్దవిగా ఉంటాయి.', 'కింది సంఖ్య ఎంత చిన్నగా ఉంటే, భిన్నం అంత పెద్దదిగా ఉంటుంది.', 'పిజ్జా యొక్క ఏ ముక్క పెద్దదిగా ఉంటుందో ఆలోచించండి.'] },
        { id: 3, text: 'What is 1/2 + 1/2?', text_hi: '1/2 + 1/2 क्या है?', text_te: '1/2 + 1/2 ఎంత?', options: [{ id: 'a', text: '1/4', text_hi: '1/4', text_te: '1/4' },{ id: 'b', text: '2/4', text_hi: '2/4', text_te: '2/4' },{ id: 'c', text: '1', text_hi: '1', text_te: '1' },{ id: 'd', text: '2', text_hi: '2', text_te: '2' }], correctAnswer: 'c', difficulty: 'easy', hints: ['Two halves make a whole.', 'If you have half a pizza and get another half, you have a whole pizza.', 'The answer is a whole number.'], hints_hi: ['दो आधे मिलकर एक पूरा बनाते हैं।', 'यदि आपके पास आधा पिज्जा है और आपको दूसरा आधा मिलता है, तो आपके पास एक पूरा पिज्जा है।', 'उत्तर एक पूर्ण संख्या है।'], hints_te: ['రెండు సగాలు ఒక పూర్తిని చేస్తాయి.', 'మీ దగ్గర సగం పిజ్జా ఉంటే మరియు మరొక సగం వస్తే, మీ దగ్గర పూర్తి పిజ్జా ఉంటుంది.', 'సమాధానం ఒక పూర్ణ సంఖ్య.'] },
        { id: 4, text: 'If a pizza has 8 slices and you eat 2, what fraction of the pizza did you eat?', text_hi: 'यदि एक पिज्जा में 8 स्लाइस हैं और आप 2 खाते हैं, तो आपने पिज्जा का कितना भिन्न खाया?', text_te: 'ఒక పిజ్జాలో 8 ముక్కలు ఉంటే మరియు మీరు 2 తింటే, మీరు పిజ్జాలో ఎంత భిన్నం తిన్నారు?', options: [{ id: 'a', text: '1/8', text_hi: '1/8', text_te: '1/8' },{ id: 'b', text: '2/8', text_hi: '2/8', text_te: '2/8' },{ id: 'c', text: '6/8', text_hi: '6/8', text_te: '6/8' },{ id: 'd', text: '8/2', text_hi: '8/2', text_te: '8/2' }], correctAnswer: 'b', difficulty: 'easy', hints: ['The bottom number is the total number of slices.', 'The top number is how many you ate.', 'This fraction can be simplified.'], hints_hi: ['नीचे की संख्या स्लाइस की कुल संख्या है।', 'ऊपर की संख्या यह है कि आपने कितने खाए।', 'इस भिन्न को सरल बनाया जा सकता है।'], hints_te: ['కింది సంఖ్య మొత్తం ముక్కల సంఖ్య.', 'పై సంఖ్య మీరు ఎన్ని తిన్నారనేది.', 'ఈ భిన్నాన్ని సరళీకరించవచ్చు.'] },
        { id: 5, text: '2/8 is the same as which fraction?', text_hi: '2/8 किस भिन्न के समान है?', text_te: '2/8 ఏ భిన్నానికి సమానం?', options: [{ id: 'a', text: '1/4', text_hi: '1/4', text_te: '1/4' },{ id: 'b', text: '1/2', text_hi: '1/2', text_te: '1/2' },{ id: 'c', text: '1/3', text_hi: '1/3', text_te: '1/3' },{ id: 'd', text: '3/4', text_hi: '3/4', text_te: '3/4' }], correctAnswer: 'a', difficulty: 'easy', hints: ['Simplify the fraction by dividing the top and bottom by the same number.', 'Both numbers can be divided by 2.', 'Think of a pizza with 8 slices. Eating 2 slices is the same as eating one quarter of the pizza.'], hints_hi: ['भिन्न को ऊपर और नीचे समान संख्या से विभाजित करके सरल करें।', 'दोनों संख्याओं को 2 से विभाजित किया जा सकता है।', '8 स्लाइस वाले पिज्जा के बारे में सोचें। 2 स्लाइस खाना पिज्जा का एक चौथाई खाने के बराबर है।'], hints_te: ['భిన్నాన్ని పై మరియు కింది సంఖ్యను ఒకే సంఖ్యతో భాగించడం ద్వారా సరళీకరించండి.', 'రెండు సంఖ్యలను 2 తో భాగించవచ్చు.', '8 ముక్కల పిజ్జా గురించి ఆలోచించండి। 2 ముక్కలు తినడం పిజ్జాలో నాలుగింట ఒక వంతు తినడంతో సమానం.'] }
    ]
  },
  {
    ...
    questions: [
        { id: 1, text: 'How many minutes are in an hour?', text_hi: 'एक घंटे में कितने मिनट होते हैं?', text_te: 'ఒక గంటలో ఎన్ని నిమిషాలు ఉంటాయి?', options: [{ id: 'a', text: '30', text_hi: '30', text_te: '30' },{ id: 'b', text: '60', text_hi: '60', text_te: '60' },{ id: 'c', text: '90', text_hi: '90', text_te: '90' },{ id: 'd', text: '100', text_hi: '100', text_te: '100' }], correctAnswer: 'b', difficulty: 'easy', hints: ['Count by 5s around the clock face.', 'The long hand on a clock counts these.', 'There are 60 seconds in a minute.'], hints_hi: ['घड़ी के चेहरे के चारों ओर 5 से गिनें।', 'घड़ी पर लंबी सुई इन्हें गिनती है।', 'एक मिनट में 60 सेकंड होते हैं।'], hints_te: ['గడియారం ముఖం చుట్టూ 5ల ద్వారా లెక్కించండి.', 'గడియారంపై పొడవైన ముల్లు వీటిని లెక్కిస్తుంది.', 'ఒక నిమిషంలో 60 సెకన్లు ఉంటాయి.'] },
        { id: 2, text: 'If the long hand points to the 6 and the short hand is between 2 and 3, what time is it?', text_hi: 'यदि लंबी सुई 6 पर है और छोटी सुई 2 और 3 के बीच है, तो क्या समय है?', text_te: 'పొడవైన ముల్లు 6 వైపు మరియు చిన్న ముల్లు 2 మరియు 3 మధ్య ఉంటే, సమయం ఎంత?', options: [{ id: 'a', text: '2:00', text_hi: '2:00', text_te: '2:00' },{ id: 'b', text: '3:30', text_hi: '3:30', text_te: '3:30' },{ id: 'c', text: '2:30', text_hi: '2:30', text_te: '2:30' },{ id: 'd', text: '6:15', text_hi: '6:15', text_te: '6:15' }], correctAnswer: 'c', difficulty: 'easy', hints: ['The long hand on the 6 means "half past".', 'The short hand points to the hour.', 'It is past 2 o\'clock.'], hints_hi: ['6 पर लंबी सुई का मतलब है "साढ़े"।', 'छोटी सुई घंटे को इंगित करती है।', 'यह 2 बजे से अधिक है।'], hints_te: ['6 పై పొడవైన ముల్లు అంటే "అర గంట గడిచింది" అని అర్థం.', 'చిన్న ముల్లు గంటను సూచిస్తుంది.', 'ఇది 2 గంటలు దాటింది.'] },
        { id: 3, text: 'How many hours are in a day?', text_hi: 'एक दिन में कितने घंटे होते हैं?', text_te: 'ఒక రోజులో ఎన్ని గంటలు ఉంటాయి?', options: [{ id: 'a', text: '12', text_hi: '12', text_te: '12' },{ id: 'b', text: '24', text_hi: '24', text_te: '24' },{ id: 'c', text: '30', text_hi: '30', text_te: '30' },{ id: 'd', text: '60', text_hi: '60', text_te: '60' }], correctAnswer: 'b', difficulty: 'easy', hints: ['It includes both daytime and nighttime.', 'A clock goes around twice.', 'It is two sets of 12 hours.'], hints_hi: ['इसमें दिन और रात दोनों शामिल हैं।', 'एक घड़ी दो बार घूमती है।', 'यह 12 घंटे के दो सेट हैं।'], hints_te: ['ఇందులో పగలు మరియు రాత్రి రెండూ ఉంటాయి.', 'ఒక గడియారం రెండుసార్లు చుట్టూ తిరుగుతుంది.', 'ఇది 12 గంటల రెండు సెట్లు.'] },
        { id: 4, text: 'What time is 15 minutes after 4:00?', text_hi: '4:00 के 15 मिनट बाद क्या समय है?', text_te: '4:00 తర్వాత 15 నిమిషాలకు సమయం ఎంత?', options: [{ id: 'a', text: '4:15', text_hi: '4:15', text_te: '4:15' },{ id: 'b', text: '4:30', text_hi: '4:30', text_te: '4:30' },{ id: 'c', text: '5:00', text_hi: '5:00', text_te: '5:00' },{ id: 'd', text: '3:45', text_hi: '3:45', text_te: '3:45' }], correctAnswer: 'a', difficulty: 'easy', hints: ['This is also called "a quarter past 4".', 'The minute hand would point to the 3.', 'Add 15 to the minutes.'], hints_hi: ['इसे "सवा चार" भी कहा जाता है।', 'मिनट की सुई 3 को इंगित करेगी।', 'मिनटों में 15 जोड़ें।'], hints_te: ['దీనిని "నాలుగుంపావు" అని కూడా అంటారు.', 'నిమిషాల ముల్లు 3 వైపు సూచిస్తుంది.', 'నిమిషాలకు 15 జోడించండి.'] },
        { id: 5, text: 'How many days are in a week?', text_hi: 'एक सप्ताह में कितने दिन होते हैं?', text_te: 'ఒక వారంలో ఎన్ని రోజులు ఉంటాయి?', options: [{ id: 'a', text: '5', text_hi: '5', text_te: '5' },{ id: 'b', text: '7', text_hi: '7', text_te: '7' },{ id: 'c', text: '10', text_hi: '10', text_te: '10' },{ id: 'd', text: '12', text_hi: '12', text_te: '12' }], correctAnswer: 'b', difficulty: 'easy', hints: ['Starts with Sunday or Monday.', 'Includes the weekend.', 'Can you name them all?'], hints_hi: ['रविवार या सोमवार से शुरू होता है।', 'सप्ताहांत शामिल है।', 'क्या आप उन सभी का नाम बता सकते हैं?'], hints_te: ['ఆదివారం లేదా సోమవారంతో ప్రారంభమవుతుంది.', 'వారాంతం ఉంటుంది.', 'మీరు వాటన్నిటినీ పేరు పెట్టగలరా?'] }
    ]
  },
  {
    ...
    questions: [
        { id: 1, text: 'Which is longer? A meter or a centimeter?', text_hi: 'कौन सा लंबा है? एक मीटर या एक सेंटीमीटर?', text_te: 'ఏది పొడవుగా ఉంటుంది? ఒక మీటరా లేదా ఒక సెంటీమీటరా?', options: [{ id: 'a', text: 'Centimeter', text_hi: 'सेंटीमीटर', text_te: 'సెంటీమీటర్' },{ id: 'b', text: 'Meter', text_hi: 'मीटर', text_te: 'మీటర్' },{ id: 'c', text: 'They are the same', text_hi: 'वे समान हैं', text_te: 'అవి సమానం' }], correctAnswer: 'b', difficulty: 'easy', hints: ['There are 100 centimeters in a meter.', 'You would measure a room in meters.', 'You would measure a pencil in centimeters.'], hints_hi: ['एक मीटर में 100 सेंटीमीटर होते हैं।', 'आप एक कमरे को मीटर में मापेंगे।', 'आप एक पेंसिल को सेंटीमीटर में मापेंगे।'], hints_te: ['ఒక మీటర్‌లో 100 సెంటీమీటర్లు ఉంటాయి.', 'మీరు ఒక గదిని మీటర్లలో కొలుస్తారు.', 'మీరు ఒక పెన్సిల్‌ను సెంటీమీటర్లలో కొలుస్తారు.'] },
        { id: 2, text: 'Which is heavier? A kilogram or a gram?', text_hi: 'कौन सा भारी है? एक किलोग्राम या एक ग्राम?', text_te: 'ఏది బరువుగా ఉంటుంది? ఒక కిలోగ్రామా లేదా ఒక గ్రామా?', options: [{ id: 'a', text: 'Gram', text_hi: 'ग्राम', text_te: 'గ్రామ్' },{ id: 'b', text: 'Kilogram', text_hi: 'किलोग्राम', text_te: 'కిలోగ్రామ్' },{ id: 'c', text: 'They are the same', text_hi: 'वे समान हैं', text_te: 'అవి సమానం' }], correctAnswer: 'b', difficulty: 'easy', hints: ['There are 1000 grams in a kilogram.', 'You would measure a person\'s weight in kilograms.', 'You would measure a feather in grams.'], hints_hi: ['एक किलोग्राम में 1000 ग्राम होते हैं।', 'आप एक व्यक्ति के वजन को किलोग्राम में मापेंगे।', 'आप एक पंख को ग्राम में मापेंगे।'], hints_te: ['ఒక కిలోగ్రామ్‌లో 1000 గ్రాములు ఉంటాయి.', 'మీరు ఒక వ్యక్తి బరువును కిలోగ్రాములలో కొలుస్తారు.', 'మీరు ఒక ఈకను గ్రాములలో కొలుస్తారు.'] },
        { id: 3, text: 'How many milliliters are in a liter?', text_hi: 'एक लीटर में कितने मिलीलीटर होते हैं?', text_te: 'ఒక లీటర్‌లో ఎన్ని మిల్లీలీటర్లు ఉంటాయి?', options: [{ id: 'a', text: '10', text_hi: '10', text_te: '10' },{ id: 'b', text: '100', text_hi: '100', text_te: '100' },{ id: 'c', text: '1000', text_hi: '1000', text_te: '1000' },{ id: 'd', text: '10000', text_hi: '10000', text_te: '10000' }], correctAnswer: 'c', difficulty: 'easy', hints: ['"Milli" means one-thousandth.', 'A large bottle of soda is often 1 or 2 liters.', 'It measures volume.'], hints_hi: ['"मिली" का अर्थ है एक-हजारवां।', 'सोडा की एक बड़ी बोतल अक्सर 1 या 2 लीटर की होती है।', 'यह आयतन मापता है।'], hints_te: ['"మిల్లీ" అంటే వెయ్యవ వంతు.', 'ఒక పెద్ద సోడా బాటిల్ తరచుగా 1 లేదా 2 లీటర్లు ఉంటుంది.', 'ఇది ఘనపరిమాణాన్ని కొలుస్తుంది.'] },
        { id: 4, text: 'What tool would you use to measure the length of a book?', text_hi: 'एक किताब की लंबाई मापने के लिए आप किस उपकरण का उपयोग करेंगे?', text_te: 'ఒక పుస్తకం పొడవును కొలవడానికి మీరు ఏ పరికరాన్ని ఉపయోగిస్తారు?', options: [{ id: 'a', text: 'A scale', text_hi: 'एक पैमाना', text_te: 'ఒక స్కేల్' },{ id: 'b', text: 'A ruler', text_hi: 'एक रूलर', text_te: 'ఒక రూలర్' },{ id: 'c', text: 'A measuring cup', text_hi: 'एक मापने वाला कप', text_te: 'ఒక కొలిచే కప్పు' },{ id: 'd', text: 'A clock', text_hi: 'एक घड़ी', text_te: 'ఒక గడియారం' }], correctAnswer: 'b', difficulty: 'easy', hints: ['It has markings for centimeters or inches.', 'It is straight.', 'You use it in school.'], hints_hi: ['इसमें सेंटीमीटर या इंच के निशान होते हैं।', 'यह सीधा होता है।', 'आप इसे स्कूल में इस्तेमाल करते हैं।'], hints_te: ['దానికి సెంటీమీటర్లు లేదా అంగుళాల గుర్తులు ఉంటాయి.', 'ఇది నిటారుగా ఉంటుంది.', 'మీరు దానిని పాఠశాలలో ఉపయోగిస్తారు.'] },
        { id: 5, text: 'Which unit would you use to measure the distance between two cities?', text_hi: 'दो शहरों के बीच की दूरी मापने के लिए आप किस इकाई का उपयोग करेंगे?', text_te: 'రెండు నగరాల మధ్య దూరాన్ని కొలవడానికి మీరు ఏ యూనిట్‌ను ఉపయోగిస్తారు?', options: [{ id: 'a', text: 'Centimeters', text_hi: 'सेंटीमीटर', text_te: 'సెంటీమీటర్లు' },{ id: 'b', text: 'Meters', text_hi: 'मीटर', text_te: 'మీటర్లు' },{ id: 'c', text: 'Kilometers', text_hi: 'किलोमीटर', text_te: 'కిలోమీటర్లు' },{ id: 'd', text: 'Milliliters', text_hi: 'मिलीलीटर', text_te: 'మిల్లీలీటర్లు' }], correctAnswer: 'c', difficulty: 'easy', hints: ['It is a very large unit of length.', '"Kilo" means one thousand.', 'It is 1000 meters.'], hints_hi: ['यह लंबाई की एक बहुत बड़ी इकाई है।', '"किलो" का अर्थ है एक हजार।', 'यह 1000 मीटर है।'], hints_te: ['ఇది పొడవు యొక్క చాలా పెద్ద యూనిట్.', '"కిలో" అంటే వెయ్యి.', 'ఇది 1000 మీటర్లు.'] }
    ]
  },
