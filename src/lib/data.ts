...
export const missions: Mission[] = [
  ...
  },
  {
    ...
    questions: [
        { id: 1, text: 'Which sense do you use your eyes for?', text_hi: 'आप अपनी आंखों का उपयोग किस इंद्रिय के लिए करते हैं?', text_te: 'మీరు మీ కళ్ళను ఏ ఇంద్రియం కోసం ఉపయోగిస్తారు?', options: [{ id: 'a', text: 'Hearing', text_hi: 'सुनना', text_te: 'వినడం' },{ id: 'b', text: 'Smell', text_hi: 'सूंघना', text_te: 'వాసన' },{ id: 'c', text: 'Sight', text_hi: 'देखना', text_te: 'చూపు' },{ id: 'd', text: 'Touch', text_hi: 'स्पर्श', text_te: 'స్పర్శ' }], correctAnswer: 'c', difficulty: 'easy', type: 'mcq', hints: ['It helps you see colors.', 'It helps you read books.', 'You cannot do it in the dark.'], hints_hi: ['यह आपको रंग देखने में मदद करता है।', 'यह आपको किताबें पढ़ने में मदद करता है।', 'आप इसे अंधेरे में नहीं कर सकते।'], hints_te: ['ఇది మీకు రంగులను చూడటానికి సహాయపడుతుంది.', 'ఇది మీకు పుస్తకాలు చదవడానికి సహాయపడుతుంది.', 'మీరు దానిని చీకటిలో చేయలేరు.'] },
        { id: 2, text: 'Which sense do you use your nose for?', text_hi: 'आप अपनी नाक का उपयोग किस इंद्रिय के लिए करते हैं?', text_te: 'మీరు మీ ముక్కును ఏ ఇంద్రియం కోసం ఉపయోగిస్తారు?', options: [{ id: 'a', text: 'Taste', text_hi: 'स्वाद', text_te: 'రుచి' },{ id: 'b', text: 'Smell', text_hi: 'सूंघना', text_te: 'వాసన' },{ id: 'c', text: 'Hearing', text_hi: 'सुनना', text_te: 'వినడం' },{ id: 'd', text: 'Sight', text_hi: 'देखना', text_te: 'చూపు' }], correctAnswer: 'b', difficulty: 'easy', type: 'mcq', hints: ['It helps you enjoy flowers.', 'It can warn you of spoiled food.', 'A dog has a very good sense of this.'], hints_hi: ['यह आपको फूलों का आनंद लेने में मदद करता है।', 'यह आपको खराब भोजन की चेतावनी दे सकता है।', 'एक कुत्ते में यह इंद्रिय बहुत अच्छी होती है।'], hints_te: ['ఇది మీకు పువ్వులను ఆస్వాదించడానికి సహాయపడుతుంది.', 'ఇది మీకు పాడైపోయిన ఆహారం గురించి హెచ్చరించగలదు.', 'కుక్కకు ఈ ఇంద్రియం చాలా బాగుంటుంది.'] },
        { id: 3, text: 'Which sense do you use your ears for?', text_hi: 'आप अपने कानों का उपयोग किस इंद्रिय के लिए करते हैं?', text_te: 'మీరు మీ చెవులను ఏ ఇంద్రియం కోసం ఉపయోగిస్తారు?', options: [{ id: 'a', text: 'Touch', text_hi: 'स्पर्श', text_te: 'స్పర్శ' },{ id: 'b', text: 'Taste', text_hi: 'स्वाद', text_te: 'రుచి' },{ id: 'c', text: 'Sight', text_hi: 'देखना', text_te: 'చూపు' },{ id: 'd', text: 'Hearing', text_hi: 'सुनना', text_te: 'వినడం' }], correctAnswer: 'd', difficulty: 'easy', type: 'mcq', hints: ['It helps you listen to music.', 'It helps you hear people talking.', 'Loud noises can hurt it.'], hints_hi: ['यह आपको संगीत सुनने में मदद करता है।', 'यह आपको लोगों को बात करते हुए सुनने में मदद करता है।', 'तेज आवाजें इसे चोट पहुंचा सकती हैं।'], hints_te: ['ఇది మీకు సంగీతం వినడానికి సహాయపడుతుంది.', 'ఇది మీకు ప్రజలు మాట్లాడటం వినడానికి సహాయపడుతుంది.', 'గట్టి శబ్దాలు దానిని గాయపరచగలవు.'] },
        { id: 4, text: 'Which sense do you use your tongue for?', text_hi: 'आप अपनी जीभ का उपयोग किस इंद्रिय के लिए करते हैं?', text_te: 'మీరు మీ నాలుకను ఏ ఇంద్రియం కోసం ఉపయోగిస్తారు?', options: [{ id: 'a', text: 'Smell', text_hi: 'सूंघना', text_te: 'వాసన' },{ id: 'b', text: 'Hearing', text_hi: 'सुनना', text_te: 'వినడం' },{ id: 'c', text: 'Taste', text_hi: 'स्वाद', text_te: 'రుచి' },{ id: 'd', text: 'Touch', text_hi: 'स्पर्श', text_te: 'స్పర్శ' }], correctAnswer: 'c', difficulty: 'easy', type: 'mcq', hints: ['It can detect sweet, sour, salty, and bitter.', 'It helps you enjoy food.', 'It works with your sense of smell.'], hints_hi: ['यह मीठा, खट्टा, नमकीन और कड़वा पता लगा सकता है।', 'यह आपको भोजन का आनंद लेने में मदद करता है।', 'यह आपकी सूंघने की इंद्रिय के साथ काम करता है।'], hints_te: ['ఇది తీపి, పులుపు, ఉప్పు మరియు చేదును గుర్తించగలదు.', 'ఇది మీకు ఆహారాన్ని ఆస్వాదించడానికి సహాయపడుతుంది.', 'ఇది మీ వాసన ఇంద్రియంతో కలిసి పనిచేస్తుంది.'] },
        { id: 5, text: 'Which sense do you use your skin for?', text_hi: 'आप अपनी त्वचा का उपयोग किस इंद्रिय के लिए करते हैं?', text_te: 'మీరు మీ చర్మాన్ని ఏ ఇంద్రియం కోసం ఉపయోగిస్తారు?', options: [{ id: 'a', text: 'Sight', text_hi: 'देखना', text_te: 'చూపు' },{ id: 'b', text: 'Taste', text_hi: 'स्वाद', text_te: 'రుచి' },{ id: 'c', text: 'Smell', text_hi: 'सूंघना', text_te: 'వాసన' },{ id: 'd', text: 'Touch', text_hi: 'स्पर्श', text_te: 'స్పర్శ' }], correctAnswer: 'd', difficulty: 'easy', type: 'mcq', hints: ['It helps you feel hot and cold.', 'It helps you feel if something is soft or hard.', 'It is your body\'s largest organ.'], hints_hi: ['यह आपको गर्म और ठंडा महसूस करने में मदद करता है।', 'यह आपको महसूस करने में मदद करता है कि कोई चीज नरम है या कठोर।', 'यह आपके शरीर का सबसे बड़ा अंग है।'], hints_te: ['ఇది మీకు వేడి మరియు చల్లదనాన్ని అనుభూతి చెందడానికి సహాయపడుతుంది.', 'ఇది మీకు ఏదైనా మృదువుగా ఉందా లేదా గట్టిగా ఉందా అని అనుభూతి చెందడానికి సహాయపడుతుంది.', 'ఇది మీ శరీరం యొక్క అతిపెద్ద అవయవం.'] }
    ]
  },
  {
    id: 'biology-level-5',
    ...
    questions: [
      {
        ...
        correctAnswer: '40',
        difficulty: 'easy',
        hints: ["Think of counting by 5, eight times.", "The number ends in a zero.", "It's four tens."],
        hints_hi: ["5 को आठ बार गिनने के बारे में सोचें।", "संख्या शून्य में समाप्त होती है।", "यह चार दहाई है।"],
        hints_te: ["5 ను ఎనిమిది సార్లు లెక్కించడం గురించి ఆలోచించండి.", "సంఖ్య సున్నాతో ముగుస్తుంది.", "ఇది నాలుగు పదులు."]
      },
      {
        id: 2,
        ...
        correctAnswer: '7',
        difficulty: 'easy',
        hints: ["This is a subtraction problem.", "Count backwards from 12, five times.", "12 - 5 = ?"],
        hints_hi: ["यह एक घटाव की समस्या है।", "12 से पांच बार पीछे की ओर गिनें।", "12 - 5 = ?"],
        hints_te: ["ఇది ఒక తీసివేత సమస్య.", "12 నుండి ఐదు సార్లు వెనక్కి లెక్కించండి.", "12 - 5 = ?"]
      },
      {
        id: 3,
        ...
        correctAnswer: '10',
        difficulty: 'easy',
        hints: ["The numbers are increasing by the same amount each time.", "These are all even numbers.", "What is 8 + 2?"],
        hints_hi: ["संख्या हर बार समान मात्रा में बढ़ रही हैं।", "ये सभी सम संख्याएँ हैं।", "8 + 2 क्या है?"],
        hints_te: ["ప్రతిసారీ సంఖ్యలు ఒకే మొత్తంలో పెరుగుతున్నాయి.", "ఇవి అన్నీ సరి సంఖ్యలు.", "8 + 2 ఎంత?"]
      },
       {
        id: 4,
        ...
        correctAnswer: '3',
        difficulty: 'easy',
        hints: ["The name 'triangle' has a clue in it.", "'Tri' means three.", "Count the corners of a slice of pizza."],
        hints_hi: ["'त्रिभुज' नाम में एक सुराग है।", "'त्रि' का अर्थ है तीन।", "पिज़्ज़ा के एक टुकड़े के कोनों को गिनें।"],
        hints_te: ["'త్రిభుజం' అనే పేరులోనే ఒక క్లూ ఉంది.", "'త్రి' అంటే మూడు.", "పిజ్జా ముక్క యొక్క మూలలను లెక్కించండి."]
      },
      {
        id: 5,
        ...
        correctAnswer: '10',
        difficulty: 'easy',
        hints: ["How many times does 10 go into 100?", "Just remove one of the zeros from 100.", "10 × ? = 100"],
        hints_hi: ["100 में 10 कितनी बार जाता है?", "100 से बस एक शून्य हटा दें।", "10 × ? = 100"],
        hints_te: ["10, 100 లోకి ఎన్నిసార్లు వెళుతుంది?", "100 నుండి ఒక సున్నాను తీసివేయండి.", "10 × ? = 100"]
      }
    ]
  },
  {
  ...
  },
  {
    ...
    badge_color: 'bg-red-400 text-red-900',
    questions: [
        { id: 1, text: 'This is the first piece of the jigsaw. What is 1/2 of 10?', text_hi: 'यह आरा का पहला टुकड़ा है। 10 का 1/2 क्या है?', text_te: 'ఇది జా యొక్క మొదటి ముక్క. 10లో 1/2 ఎంత?', type: 'picture-puzzle', correctAnswer: '5', imageUrl: 'https://picsum.photos/seed/jigsaw1/400/100', imageHint: 'jigsaw puzzle', difficulty: 'easy', hints: ['It means 10 divided by 2.', 'If you have 10 sweets and share them equally with a friend, how many do you each get?', 'It is half of ten.'], hints_hi: ['इसका मतलब है 10 को 2 से विभाजित करना।', 'यदि आपके पास 10 मिठाइयाँ हैं और आप उन्हें एक दोस्त के साथ बराबर साझा करते हैं, तो प्रत्येक को कितनी मिलती हैं?', 'यह दस का आधा है।'], hints_te: ['అంటే 10 ను 2 తో భాగించడం.', 'మీ దగ్గర 10 స్వీట్లు ఉంటే మరియు వాటిని స్నేహితుడితో సమానంగా పంచుకుంటే, ప్రతి ఒక్కరికి ఎన్ని వస్తాయి?', 'ఇది పదిలో సగం.'] },
        { id: 2, text: 'You found the second piece! If a pizza has 8 slices and you eat 2, how many slices are left?', text_hi: 'आपको दूसरा टुकड़ा मिल गया! यदि एक पिज्जा में 8 स्लाइस हैं और आप 2 खाते हैं, तो कितने स्लाइस बचते हैं?', text_te: 'మీరు రెండవ ముక్కను కనుగొన్నారు! ఒక పిజ్జాలో 8 ముక్కలు ఉంటే మరియు మీరు 2 తింటే, ఎన్ని ముక్కలు మిగులుతాయి?', type: 'picture-puzzle', correctAnswer: '6', imageUrl: 'https://picsum.photos/seed/jigsaw2/400/100', imageHint: 'pizza slices', difficulty: 'easy', hints: ['This is a subtraction problem.', '8 - 2 = ?', 'Count the remaining pieces.'], hints_hi: ['यह एक घटाव की समस्या है।', '8 - 2 = ?', 'शेष टुकड़ों को गिनें।'], hints_te: ['ఇది ఒక తీసివేత సమస్య.', '8 - 2 = ?', 'మిగిలిన ముక్కలను లెక్కించండి.'] },
        { id: 3, text: 'The final piece! What is 1/2 + 1/2 equal to?', text_hi: 'अंतिम टुकड़ा! 1/2 + 1/2 किसके बराबर है?', text_te: 'చివరి ముక్క! 1/2 + 1/2 దేనికి సమానం?', type: 'picture-puzzle', correctAnswer: '1', imageUrl: 'https://picsum.photos/seed/jigsaw3/400/100', imageHint: 'math plus', difficulty: 'easy', hints: ['Two halves make a whole.', 'If you have half a pizza and get another half, you have a whole pizza.', 'The answer is a whole number.'], hints_hi: ['दो आधे मिलकर एक पूरा बनाते हैं।', 'यदि आपके पास आधा पिज्जा है और आपको दूसरा आधा मिलता है, तो आपके पास एक पूरा पिज्जा है।', 'उत्तर एक पूर्ण संख्या है।'], hints_te: ['రెండు సగాలు ఒక పూర్తిని చేస్తాయి.', 'మీ దగ్గర సగం పిజ్జా ఉంటే మరియు మరొక సగం వస్తే, మీ దగ్గర పూర్తి పిజ్జా ఉంటుంది.', 'సమాధానం ఒక పూర్ణ సంఖ్య.'] },
    ]
  },
  {
  ...
  },
  {
    ...
    badge_color: 'bg-green-400 text-green-900',
    questions: [
        { id: 1, text: "You're at the maze entrance. To take the first step, solve: 15 × 3", text_hi: "आप भूलभुलैया के प्रवेश द्वार पर हैं। पहला कदम उठाने के लिए, हल करें: 15 × 3", text_te: "మీరు చిట్టడవి ప్రవేశ ద్వారం వద్ద ఉన్నారు. మొదటి అడుగు వేయడానికి, పరిష్కరించండి: 15 × 3", type: 'mcq', correctAnswer: 'b', options: [{id: 'a', text: '35', text_hi: '35', text_te: '35'}, {id: 'b', text: '45', text_hi: '45', text_te: '45'}, {id: 'c', text: '55', text_hi: '55', text_te: '55'}], difficulty: 'easy', hints: ['10 times 3 is 30.', '5 times 3 is 15.', '30 + 15 = ?'], hints_hi: ['10 गुना 3, 30 है।', '5 गुना 3, 15 है।', '30 + 15 = ?'], hints_te: ['10 రెట్లు 3, 30.', '5 రెట్లు 3, 15.', '30 + 15 = ?'] },
        { id: 2, text: 'You turn left. The path splits. The correct path is the answer to: 120 ÷ 4', text_hi: 'आप बाईं ओर मुड़ते हैं। रास्ता विभाजित होता है। सही रास्ता इसका उत्तर है: 120 ÷ 4', text_te: 'మీరు ఎడమవైపు తిరుగుతారు. మార్గం విడిపోతుంది. సరైన మార్గం దీనికి సమాధానం: 120 ÷ 4', type: 'mcq', correctAnswer: 'a', options: [{id: 'a', text: '30', text_hi: '30', text_te: '30'}, {id: 'b', text: '40', text_hi: '40', text_te: '40'}, {id: 'c', text: '25', text_hi: '25', text_te: '25'}], difficulty: 'medium', hints: ['How many times does 4 go into 12?', '12 divided by 4 is 3.', 'Don\'t forget the zero!'], hints_hi: ['12 में 4 कितनी बार जाता है?', '12 को 4 से विभाजित करने पर 3 आता है।', 'शून्य को मत भूलना!'], hints_te: ['12 లో 4 ఎన్నిసార్లు పోతుంది?', '12 ను 4 తో భాగిస్తే 3 వస్తుంది.', 'సున్నాని మర్చిపోవద్దు!'] },
        { id: 3, text: "You're getting closer! To cross the bridge, you need to know the square root of 81.", text_hi: "आप करीब आ रहे हैं! पुल पार करने के लिए, आपको 81 का वर्गमूल जानना होगा।", text_te: "మీరు దగ్గరికి వస్తున్నారు! వంతెన దాటడానికి, మీకు 81 యొక్క వర్గమూలం తెలియాలి.", type: 'mcq', correctAnswer: 'c', options: [{id: 'a', text: '7', text_hi: '7', text_te: '7'}, {id: 'b', text: '8', text_hi: '8', text_te: '8'}, {id: 'c', text: '9', text_hi: '9', text_te: '9'}], difficulty: 'medium', hints: ['What number multiplied by itself equals 81?', '8 x 8 is 64.', '9 x 9 = ?'], hints_hi: ['किस संख्या को उसी से गुणा करने पर 81 आता है?', '8 x 8, 64 है।', '9 x 9 = ?'], hints_te: ['ఏ సంఖ్యను దానితోనే గుణిస్తే 81 వస్తుంది?', '8 x 8, 64.', '9 x 9 = ?'] },
        { id: 4, text: 'The final door! The key is the answer to: (5 + 3) × 6', text_hi: 'अंतिम दरवाजा! कुंजी इसका उत्तर है: (5 + 3) × 6', text_te: 'చివరి తలుపు! కీ దీనికి సమాధానం: (5 + 3) × 6', type: 'mcq', correctAnswer: 'b', options: [{id: 'a', text: '38', text_hi: '38', text_te: '38'}, {id: 'b', text: '48', text_hi: '48', text_te: '48'}, {id: 'c', text: '56', text_hi: '56', text_te: '56'}], difficulty: 'hard', hints: ['First, solve what is inside the parentheses.', '5 + 3 = 8.', 'Now, what is 8 × 6?'], hints_hi: ['पहले, कोष्ठक के अंदर क्या है उसे हल करें।', '5 + 3 = 8।', 'अब, 8 × 6 क्या है?'], hints_te: ['మొదట, కుండలీకరణాల లోపల ఉన్నదాన్ని పరిష్కరించండి.', '5 + 3 = 8.', 'ఇప్పుడు, 8 × 6 ఎంత?'] }
    ]
  },
  {
    ...
    questions: [
        { id: 1, text: 'First letter: 26 - 13 = ? (The 13th letter of the alphabet)', text_hi: 'पहला अक्षर: 26 - 13 = ? (वर्णमाला का 13वां अक्षर)', text_te: 'మొదటి అక్షరం: 26 - 13 = ? (వర్ణమాల యొక్క 13వ అక్షరం)', type: 'mcq', correctAnswer: 'a', options: [{id: 'a', text: '13 (M)', text_hi: '13 (M)', text_te: '13 (M)'}, {id: 'b', text: '12 (L)', text_hi: '12 (L)', text_te: '12 (L)'}], difficulty: 'easy', hints: ['This is a simple subtraction.', 'The answer is the first letter of "Math".'], hints_hi: ['यह एक साधारण घटाव है।', 'उत्तर "Math" का पहला अक्षर है।'], hints_te: ['ఇది ఒక సాధారణ తీసివేత.', 'సమాధానం "Math" యొక్క మొదటి అక్షరం.'] },
        { id: 2, text: 'Second letter: 1 × 1 = ? (The 1st letter of the alphabet)', text_hi: 'दूसरा अक्षर: 1 × 1 = ? (वर्णमाला का पहला अक्षर)', text_te: 'రెండవ అక్షరం: 1 × 1 = ? (వర్ణమాల యొక్క 1వ అక్షరం)', type: 'mcq', correctAnswer: 'b', options: [{id: 'a', text: '2 (B)', text_hi: '2 (B)', text_te: '2 (B)'}, {id: 'b', text: '1 (A)', text_hi: '1 (A)', text_te: '1 (A)'}], difficulty: 'easy', hints: ['Any number multiplied by 1 is itself.', 'The answer is the second letter of "Math".'], hints_hi: ['किसी भी संख्या को 1 से गुणा करने पर वह स्वयं होती है।', 'उत्तर "Math" का दूसरा अक्षर है।'], hints_te: ['ఏదైనా సంఖ్యను 1 తో గుణిస్తే అదే వస్తుంది.', 'సమాధానం "Math" యొక్క రెండవ అక్షరం.'] },
        { id: 3, text: 'Third letter: 100 ÷ 5 = ? (The 20th letter of the alphabet)', text_hi: 'तीसरा अक्षर: 100 ÷ 5 = ? (वर्णमाला का 20वां अक्षर)', text_te: 'మూడవ అక్షరం: 100 ÷ 5 = ? (వర్ణమాల యొక్క 20వ అక్షరం)', type: 'mcq', correctAnswer: 'a', options: [{id: 'a', text: '20 (T)', text_hi: '20 (T)', text_te: '20 (T)'}, {id: 'b', text: '25 (Y)', text_hi: '25 (Y)', text_te: '25 (Y)'}], difficulty: 'medium', hints: ['How many 5s are in 100?', 'The answer is the third letter of "Math".'], hints_hi: ['100 में कितने 5 हैं?', 'उत्तर "Math" का तीसरा अक्षर है।'], hints_te: ['100 లో ఎన్ని 5లు ఉన్నాయి?', 'సమాధానం "Math" యొక్క మూడవ అక్షరం.'] },
        { id: 4, text: 'Fourth letter: 2 × 2 × 2 = ? (The 8th letter of the alphabet)', text_hi: 'चौथा अक्षर: 2 × 2 × 2 = ? (वर्णमाला का 8वां अक्षर)', text_te: 'నాల్గవ అక్షరం: 2 × 2 × 2 = ? (వర్ణమాల యొక్క 8వ అక్షరం)', type: 'mcq', correctAnswer: 'b', options: [{id: 'a', text: '6 (F)', text_hi: '6 (F)', text_te: '6 (F)'}, {id: 'b', text: '8 (H)', text_hi: '8 (H)', text_te: '8 (H)'}], difficulty: 'medium', hints: ['2 times 2 is 4. What is 4 times 2?', 'The answer is the last letter of "Math".'], hints_hi: ['2 गुना 2, 4 है। 4 गुना 2 क्या है?', 'उत्तर "Math" का अंतिम अक्षर है।'], hints_te: ['2 రెట్లు 2, 4. 4 రెట్లు 2 ఎంత?', 'సమాధానం "Math" యొక్క చివరి అక్షరం.'] },
        { id: 5, text: "You've collected the letters M, A, T, H. What is the secret word?", text_hi: "आपने M, A, T, H अक्षर एकत्र किए हैं। गुप्त शब्द क्या है?", text_te: "మీరు M, A, T, H అక్షరాలను సేకరించారు. రహస్య పదం ఏమిటి?", type: 'puzzle', correctAnswer: 'math', difficulty: 'easy', hints: ['Unscramble the letters.', 'It is the subject you are playing right now.'], hints_hi: ['अक्षरों को सुलझाएं।', 'यह वह विषय है जिसे आप अभी खेल रहे हैं।'], hints_te: ['అక్షరాలను సరిగ్గా అమర్చండి.', 'ఇది మీరు ఇప్పుడు ఆడుతున్న విషయం.'] }
    ]
  },
    ...
    questions: [
      {
        ...
        difficulty: 'easy',
        type: 'mcq',
        hints: ["An adjective describes a noun.", "Which word describes the door?", "It means the door was hard to push."],
        hints_hi: ["विशेषण संज्ञा का वर्णन करता है।", "कौन सा शब्द दरवाजे का वर्णन करता है?", "इसका मतलब है कि दरवाजा धकेलना मुश्किल था।"],
        hints_te: ["విశేషణం నామవాచకాన్ని వివరిస్తుంది.", "ఏ పదం తలుపును వివరిస్తుంది?", "అంటే తలుపును నెట్టడం కష్టమని అర్థం."]
      },
      {
        id: 2,
        ...
        difficulty: 'medium',
        type: 'mcq',
        hints: ["An adverb describes a verb.", "How did the cat walk?", "Many adverbs end in '-ly'."],
        hints_hi: ["क्रियाविशेषण क्रिया का वर्णन करता है।", "बिल्ली कैसे चली?", "कई क्रियाविशेषण '-ly' में समाप्त होते हैं।"],
        hints_te: ["క్రియా విశేషణం క్రియను వివరిస్తుంది.", "పిల్లి ఎలా నడిచింది?", "చాలా క్రియా విశేషణాలు '-ly' తో ముగుస్తాయి."]
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        difficulty: 'easy',
        type: 'mcq',
        hints: ["It shows the position of the book.", "The book is resting on the surface.", "It's the opposite of 'under'."],
        hints_hi: ["यह किताब की स्थिति को दर्शाता है।", "किताब सतह पर रखी है।", "यह 'नीचे' का उल्टा है।"],
        hints_te: ["ఇది పుస్తకం యొక్క స్థానాన్ని చూపుతుంది.", "పుస్తకం ఉపరితలంపై ఉంది.", "ఇది 'కింద'కి వ్యతిరేకం."]
      },
      {
        id: 2,
        ...
        difficulty: 'easy',
        type: 'mcq',
        hints: ["The fish is surrounded by water.", "It means 'inside'.", "You are sitting 'in' a chair."],
        hints_hi: ["मछली पानी से घिरी हुई है।", "इसका मतलब है 'अंदर'।", "आप एक कुर्सी 'में' बैठे हैं।"],
        hints_te: ["చేప నీటితో చుట్టుముట్టబడి ఉంది.", "దీని అర్థం 'లోపల'.", "మీరు ఒక కుర్చీ 'లో' కూర్చున్నారు."]
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        difficulty: 'easy',
        type: 'mcq',
        hints: ["Past tense means it already happened.", "Today I go, yesterday I...", "It describes a completed action."],
        hints_hi: ["भूतकाल का मतलब है कि यह पहले ही हो चुका है।", "आज मैं जाता हूँ, कल मैं...", "यह एक पूर्ण क्रिया का वर्णन करता है।"],
        hints_te: ["భూతకాలం అంటే అది ఇప్పటికే జరిగిపోయింది.", "ఈ రోజు నేను వెళతాను, నిన్న నేను...", "ఇది ఒక పూర్తి చర్యను వివరిస్తుంది."]
      },
      {
        id: 2,
        ...
        difficulty: 'easy',
        type: 'mcq',
        hints: ["Future tense means it has not happened yet.", "The word 'tomorrow' is a clue.", "It often uses the word 'will'."],
        hints_hi: ["भविष्य काल का मतलब है कि यह अभी तक नहीं हुआ है।", "'कल' शब्द एक सुराग है।", "इसमें अक्सर 'करेगा' शब्द का प्रयोग होता है।"],
        hints_te: ["భవిష్యత్ కాలం అంటే అది ఇంకా జరగలేదు.", "'రేపు' అనే పదం ఒక ఆధారం.", "ఇది తరచుగా 'will' అనే పదాన్ని ఉపయోగిస్తుంది."]
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        difficulty: 'easy',
        type: 'mcq',
        hints: ["The subject is who or what is doing the action.", "Who chased the ball?", "It is the noun performing the verb."],
        hints_hi: ["विषय वह है जो क्रिया कर रहा है।", "गेंद का पीछा किसने किया?", "यह क्रिया करने वाली संज्ञा है।"],
        hints_te: ["కర్త అంటే చర్య చేసేది ఎవరు లేదా ఏది.", "బంతిని ఎవరు వెంబడించారు?", "ఇది క్రియను చేసే నామవాచకం."]
      },
      {
        id: 2,
        ...
        difficulty: 'medium',
        type: 'mcq',
        hints: ["The predicate tells what the subject does.", "It includes the verb and the object.", "What did the girl do?"],
        hints_hi: ["विधेय बताता है कि विषय क्या करता है।", "इसमें क्रिया और वस्तु शामिल है।", "लड़की ने क्या किया?"],
        hints_te: ["కర్త ఏమి చేస్తుందో विधेయం చెబుతుంది.", "ఇందులో క్రియ మరియు కర్మ ఉంటాయి.", "అమ్మాయి ఏమి చేసింది?"]
      }
    ]
  },
  // GK Missions
  {
    ...
    badge_color: 'bg-blue-400 text-blue-900',
    questions: [
      { id: 1, text: 'What is the capital of India?', text_hi: 'भारत की राजधानी क्या है?', text_te: 'భారతదేశ రాజధాని ఏది?', options: [{ id: 'a', text: 'Mumbai', text_hi: 'मुंबई', text_te: 'ముంబై' }, { id: 'b', text: 'New Delhi', text_hi: 'नई दिल्ली', text_te: 'న్యూఢిల్లీ' }, { id: 'c', text: 'Kolkata', text_hi: 'कोलकाता', text_te: 'కోల్‌కతా' }], correctAnswer: 'b', difficulty: 'easy', type: 'mcq', hints: ['It is located in the northern part of the country.', 'The Red Fort is a famous monument there.'], hints_hi: ['यह देश के उत्तरी भाग में स्थित है।', 'लाल किला वहां का एक प्रसिद्ध स्मारक है।'], hints_te: ['ఇది దేశం యొక్క ఉత్తర భాగంలో ఉంది.', 'ఎర్రకోట అక్కడ ఒక ప్రసిద్ధ స్మారక చిహ్నం.'] },
      { id: 2, text: 'In which country would you find the Eiffel Tower?', text_hi: 'एफिल टॉवर आपको किस देश में मिलेगा?', text_te: 'ఈఫిల్ టవర్ ఏ దేశంలో ఉంది?', options: [{ id: 'a', text: 'Italy', text_hi: 'इटली', text_te: 'ఇటలీ' }, { id: 'b', text: 'Spain', text_hi: 'स्पेन', text_te: 'స్పెయిన్' }, { id: 'c', text: 'France', text_hi: 'फ्रांस', text_te: 'ఫ్రాన్స్' }], correctAnswer: 'c', difficulty: 'easy', type: 'mcq', hints: ["Its capital is Paris.", "The language spoken there is French."], hints_hi: ["इसकी राजधानी पेरिस है।", "वहाँ बोली जाने वाली भाषा फ्रेंच है।"], hints_te: ["దాని రాజధాని పారిస్.", "అక్కడ మాట్లాడే భాష ఫ్రెంచ్."] },
      { id: 3, text: 'What is the largest continent by area?', text_hi: 'क्षेत्रफल के हिसाब से सबसे बड़ा महाद्वीप कौन सा है?', text_te: 'విస్తీర్ణం ప్రకారం అతిపెద్ద ఖండం ఏది?', options: [{ id: 'a', text: 'Africa', text_hi: 'अफ्रीका', text_te: 'ఆఫ్రికా' }, { id: 'b', text: 'Asia', text_hi: 'एशिया', text_te: 'ఆసియా' }, { id: 'c', text: 'North America', text_hi: 'उत्तरी अमेरिका', text_te: 'ఉత్తర అమెరికా' }], correctAnswer: 'b', difficulty: 'easy', type: 'mcq', hints: ["India and China are in this continent.", "It is also the most populous continent."], hints_hi: ["भारत और चीन इसी महाद्वीप में हैं।", "यह सबसे अधिक आबादी वाला महाद्वीप भी है।"], hints_te: ["భారతదేశం మరియు చైనా ఈ ఖండంలో ఉన్నాయి.", "ఇది అత్యధిక జనాభా కలిగిన ఖండం కూడా."] },
    ]
  },
  {
    id: 'gk-level-2',
  ...
  },
  {
    ...
    badge_color: 'bg-green-400 text-green-900',
    questions: [
      { id: 1, text: 'Which is the longest river in the world?', text_hi: 'दुनिया की सबसे लंबी नदी कौन सी है?', text_te: 'ప్రపంచంలో అత్యంత పొడవైన నది ఏది?', options: [{ id: 'a', text: 'Amazon', text_hi: 'अमेज़ॅन', text_te: 'అమెజాన్' }, { id: 'b', text: 'Nile', text_hi: 'नील', text_te: 'నైలు' }, { id: 'c', text: 'Ganges', text_hi: 'गंगा', text_te: 'గంగా' }], correctAnswer: 'b', difficulty: 'easy', type: 'mcq', hints: ["It is located in Africa.", "Ancient Egyptian civilization depended on it."], hints_hi: ["यह अफ्रीका में स्थित है।", "प्राचीन मिस्र की सभ्यता इसी पर निर्भर थी।"], hints_te: ["ఇది ఆఫ్రికాలో ఉంది.", "ప్రాచీన ఈజిప్షియన్ నాగరికత దీనిపై ఆధారపడి ఉంది."] },
      { id: 2, text: 'What is the largest desert in the world?', text_hi: 'दुनिया का सबसे बड़ा रेगिस्तान कौन सा है?', text_te: 'ప్రపంచంలో అతిపెద్ద ఎడారి ఏది?', options: [{ id: 'a', text: 'Sahara Desert', text_hi: 'सहारा रेगिस्तान', text_te: 'సహారా ఎడారి' }, { id: 'b', text: 'Gobi Desert', text_hi: 'गोबी रेगिस्तान', text_te: 'గోబీ ఎడారి' }, { id: 'c', text: 'Antarctic Polar Desert', text_hi: 'अंटार्कटिक ध्रुवीय रेगिस्तान', text_te: 'అంటార్కిటిక్ ధ్రువ ఎడారి' }], correctAnswer: 'c', difficulty: 'hard', type: 'mcq', hints: ["It is a cold desert.", "It covers most of a continent."], hints_hi: ["यह एक ठंडा रेगिस्तान है।", "यह एक महाद्वीप के अधिकांश हिस्से को कवर करता है।"], hints_te: ["ఇది ఒక చల్లని ఎడారి.", "ఇది ఒక ఖండంలోని చాలా భాగాన్ని కవర్ చేస్తుంది."] },
    ]
  },
  {
    id: 'gk-level-4',
    ...
    badge_color: 'bg-red-400 text-red-900',
    questions: [
      { id: 1, text: 'How many players are on a cricket team?', text_hi: 'एक क्रिकेट टीम में कितने खिलाड़ी होते हैं?', text_te: 'ఒక క్రికెట్ జట్టులో ఎంతమంది ఆటగాళ్ళు ఉంటారు?', options: [{ id: 'a', text: '9', text_hi: '9', text_te: '9' }, { id: 'b', text: '11', text_hi: '11', text_te: '11' }, { id: 'c', text: '13', text_hi: '13', text_te: '13' }], correctAnswer: 'b', difficulty: 'easy', type: 'mcq', hints: ["It's more than 10.", "It's the same number as a soccer team."], hints_hi: ["यह 10 से अधिक है।", "यह एक फुटबॉल टीम के बराबर संख्या है।"], hints_te: ["ఇది 10 కంటే ఎక్కువ.", "ఇది ఒక సాకర్ జట్టు సంఖ్యతో సమానం."] },
      { id: 2, text: 'The Olympic Games are held every how many years?', text_hi: 'ओलंपिक खेल हर कितने साल में आयोजित किए जाते हैं?', text_te: 'ఒలింపిక్ క్రీడలు ఎన్ని సంవత్సరాలకు ఒకసారి జరుగుతాయి?', options: [{ id: 'a', text: '2 years', text_hi: '2 साल', text_te: '2 సంవత్సరాలు' }, { id: 'b', text: '4 years', text_hi: '4 साल', text_te: '4 సంవత్సరాలు' }, { id: 'c', text: '6 years', text_hi: '6 साल', text_te: '6 సంవత్సరాలు' }], correctAnswer: 'b', difficulty: 'easy', type: 'mcq', hints: ["It's the same number of years as a leap year cycle.", "There are Summer and Winter games."], hints_hi: ["यह एक लीप वर्ष चक्र के समान वर्षों की संख्या है।", "ग्रीष्मकालीन और शीतकालीन खेल होते हैं।"], hints_te: ["ఇది లీపు సంవత్సర చక్రం వలె అదే సంవత్సరాల సంఖ్య.", "వేసవి మరియు శీతాకాలపు క్రీడలు ఉన్నాయి."] },
    ]
  },
  {
    id: 'gk-level-5',
    ...
    badge_color: 'bg-purple-400 text-purple-900',
    questions: [
      { id: 1, text: 'What planet is known as the Red Planet?', text_hi: 'किस ग्रह को लाल ग्रह के रूप में जाना जाता है?', text_te: 'ఏ గ్రహాన్ని ఎర్ర గ్రహం అని పిలుస్తారు?', options: [{ id: 'a', text: 'Mars', text_hi: 'मंगल', text_te: 'అంగారకుడు' }, { id: 'b', text: 'Jupiter', text_hi: 'बृहस्पति', text_te: 'బృహస్పతి' }, { id: 'c', text: 'Venus', text_hi: 'शुक्र', text_te: 'శుక్రుడు' }], correctAnswer: 'a', difficulty: 'easy', type: 'mcq', hints: ["It is the fourth planet from the Sun.", "It is named after the Roman god of war."], hints_hi: ["यह सूर्य से चौथा ग्रह है।", "इसका नाम रोमन युद्ध के देवता के नाम पर रखा गया है।"], hints_te: ["ఇది సూర్యుని నుండి నాల్గవ గ్రహం.", "దీనికి రోమన్ యుద్ధ దేవుడి పేరు పెట్టారు."] },
      { id: 2, text: 'Who discovered penicillin?', text_hi: 'पेनिसिलिन की खोज किसने की?', text_te: 'పెన్సిలిన్‌ను ఎవరు కనుగొన్నారు?', options: [{ id: 'a', text: 'Marie Curie', text_hi: 'मैरी क्यूरी', text_te: 'మేరీ క్యూరీ' }, { id: 'b', text: 'Alexander Fleming', text_hi: 'अलेक्जेंडर फ्लेमिंग', text_te: 'అలెగ్జాండర్ ఫ్లెమింగ్' }, { id: 'c', text: 'Louis Pasteur', text_hi: 'लुई पाश्चर', text_te: 'లూయిస్ పాశ్చర్' }], correctAnswer: 'b', difficulty: 'medium', type: 'mcq', hints: ["He was a Scottish physician and microbiologist.", "The discovery was accidental, from a moldy petri dish."], hints_hi: ["वे एक स्कॉटिश चिकित्सक और सूक्ष्म जीवविज्ञानी थे।", "यह खोज आकस्मिक थी, एक फफूंद लगी पेट्री डिश से।"], hints_te: ["అతను స్కాటిష్ వైద్యుడు మరియు మైక్రోబయాలజిస్ట్.", "ఈ ఆవిష్కరణ యాదృచ్ఛికంగా, ఒక బూజు పట్టిన పెట్రీ డిష్ నుండి జరిగింది."] },
    ]
  }
];
